		...
		<div class="f_right">
	    	...
	    	<div class="s_detail_cutpage_my">     
	      		<div class="f_left" style="margin-right:10px;">    
	           		...
	           		<i id="arrowGo" class="s_cutpage_go" style="width:23px; margin:0;height:22px" onclick="javascript:navPage('txtGo');">GO</i>
	       		</div>
	       		<i id="arrowLeft" class="s_cutpage_arrowleft_new" style="width:23px;height:22px" onclick="javascript:navPage('lt');"></i>
	       		<div id="uiPages" class="f_left">   
	       		</div>
	       		<i id="arrowRight" class="s_cutpage_arrowright_new" style="width:23px;height:22px" onclick="javascript:navPage('nt');"></i>
	    	</div>
	   	</div>
	</div>
</div>
